...
// Note: Src from https://bitbucket.org/Unity-Technologies/ui/src/0155c39e05ca5d7dcc97d9974256ef83bc122586/UnityEngine.UI/EventSystem/InputModules/PointerInputModule.cs?at=5.2&fileviewer=file-view-default
// Taken so we can fiddle with it and have easily accesible direct reference
...
{
    public abstract class ExposedPointerInputModule : BaseInputModule
    {
        ...
        {
            var pressed = UnityEngine.Input.GetMouseButtonDown(buttonId);
            var released = UnityEngine.Input.GetMouseButtonUp(buttonId);
            if (pressed && released)
