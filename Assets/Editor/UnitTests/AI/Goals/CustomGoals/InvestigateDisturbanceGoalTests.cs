...
namespace Assets.Editor.UnitTests.AI.Goals.CustomGoals
{
    ...
    public class InvestigateDisturbanceGoalTestFixture
    {
        ...
        private InvestigateDisturbanceGoal _goal;
        ...
        public void BeforeTest()
        {
            ...
            _goal = new InvestigateDisturbanceGoal(_pathfinding.gameObject, _params);
            _goal.RegisterGoal();
        }
        ...
        [Test]
        public void Initialised_SetsTargetToNoiseLocation()
        {
